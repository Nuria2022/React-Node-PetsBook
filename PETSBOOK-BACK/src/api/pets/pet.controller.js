...
const getAllPets = async (req, res, next) => {
    try {
        ...
        return next(setError(500, error.message | 'Failed recovering all pets'));
    }
};
...
const petById = async (req, res, next) => {
    try {
        ...
        return next(setError(500, error.message || 'Failed recovering Pet'));
        }
};
...
const register = async (req, res, next) => {
    try {
        ...
        return next(setError(500, error.message || 'Failed creating Pet'));
    }
};
